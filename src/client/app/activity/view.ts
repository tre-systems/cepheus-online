...
export const SRD_CREATION_ACTIVITY_MILESTONE_TRANSITIONS = [
  ...
  'HOMEWORLD_SET',
  'COMPLETE_HOMEWORLD',
  'BACKGROUND_SKILL_SELECTED',
  'CASCADE_SKILL_RESOLVED',
  'SELECT_CAREER',
...
const transitionTitles = {
  ...
  INJURY_RESOLVED: 'Injury resolved',
  COMMISSION_PASSED: 'Commission earned',
  COMMISSION_FAILED: 'Commission missed',
  COMPLETE_COMMISSION: 'Commission earned',
  SKIP_COMMISSION: 'Commission skipped',
  ADVANCEMENT_PASSED: 'Advancement earned',
  ADVANCEMENT_FAILED: 'Advancement missed',
  ...
  AGING_LOSSES_RESOLVED: 'Aging losses resolved',
  DECIDE_ANAGATHICS: 'Anagathics decided',
  TERM_SKILL_ROLLED: 'Term skill gained',
  TERM_CASCADE_SKILL_RESOLVED: 'Term cascade resolved',
  REENLIST_ALLOWED: 'Reenlistment allowed',
  REENLIST_FORCED: 'Reenlistment forced',
  REENLIST: 'Reenlisted',

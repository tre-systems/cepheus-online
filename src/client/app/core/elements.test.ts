...
const elementIds = {
  ...
  roomInput: 'roomInput',
  userInput: 'userInput',
  betaRoomNameInput: 'betaRoomNameInput',
  betaCreateRoom: 'betaCreateRoomButton',
  betaInviteRole: 'betaInviteRoleSelect',
  betaCreateInvite: 'betaCreateInviteButton',
  betaInviteLink: 'betaInviteLinkInput',
  betaInviteToken: 'betaInviteTokenInput',
  betaAcceptInvite: 'betaAcceptInviteButton',
  betaRoomStatus: 'betaRoomStatus',
  ...
  pwaUpdateDismissButton: 'pwaUpdateDismissButton',
  ...
  notesClose: 'notesCloseButton',
  notesList: 'notesList',
  noteTitleInput: 'noteTitleInput',
  noteBodyInput: 'noteBodyInput',
  noteVisibilitySelect: 'noteVisibilitySelect',
  noteNew: 'noteNewButton',
  noteSave: 'noteSaveButton',
  noteDelete: 'noteDeleteButton',

...
import type { BoardCommand } from './app-command-router'
import type { RequiredAppElements } from './app-elements'
import type { RoomAssetCreationOptions } from './room-asset-creation-controller'
import { createRoomAssetCreationWiring } from './room-asset-creation-wiring'

...
import {
  ...
  normalizeBackgroundSkill,
  normalizeHomeworld,
  requiredBackgroundSelectionCount,
...
type CharacterCreationCharacteristicCommand = Extract<
  GameCommand,
...
type CharacterCreationSkillsMusteringCommand = Extract<
  GameCommand,
  {
    type:
...
type CharacterCreationCommand =
  ...
  | CharacterCreationLifecycleCommand
  | CharacterCreationSkillsMusteringCommand
